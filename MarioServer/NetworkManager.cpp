...
// 2. AcceptClient 함수
// ThreadManager::AcceptLoop()에서 주기적으로 호출하여 새로운 클라이언트의 연결 요청을 수락합니다.
// 클라이언트의 NetworkManager::initClient() 함수가 connect()를 호출하면 이 함수에서 accept()를 통해 연결을 수락합니다.
